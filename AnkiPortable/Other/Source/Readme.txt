DEVELOPER: Replace the three occurrences of AnkiPortable in this file
...
user in an INI file next to AnkiPortable.exe called AnkiPortable.ini.
...
copy AppNamePortable.ini from this directory to AnkiPortable.ini next to
AnkiPortable.exe. The options in the INI file are as follows:
