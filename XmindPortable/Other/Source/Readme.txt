DEVELOPER: Replace the three occurrences of XmindPortable in this file
...
user in an INI file next to XmindPortable.exe called XmindPortable.ini.
...
copy AppNamePortable.ini from this directory to XmindPortable.ini next to
XmindPortable.exe. The options in the INI file are as follows:
