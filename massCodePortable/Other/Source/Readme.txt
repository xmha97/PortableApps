...
user in an INI file next to FerdiumPortable.exe called FerdiumPortable.ini.
...
copy AppNamePortable.ini from this directory to FerdiumPortable.ini next to
FerdiumPortable.exe. The options in the INI file are as follows:
