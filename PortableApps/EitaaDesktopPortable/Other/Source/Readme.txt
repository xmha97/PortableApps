...
user in an INI file next to EitaaDesktopPortable.exe called EitaaDesktopPortable.ini.
...
copy AppNamePortable.ini from this directory to EitaaDesktopPortable.ini next to
EitaaDesktopPortable.exe. The options in the INI file are as follows:
