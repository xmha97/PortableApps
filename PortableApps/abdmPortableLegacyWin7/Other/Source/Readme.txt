DEVELOPER: Replace the three occurrences of abdmPortableLegacyWin7 in this file
...
user in an INI file next to abdmPortableLegacyWin7.exe called abdmPortableLegacyWin7.ini.
...
copy AppNamePortable.ini from this directory to abdmPortableLegacyWin7.ini next to
abdmPortableLegacyWin7.exe. The options in the INI file are as follows:
