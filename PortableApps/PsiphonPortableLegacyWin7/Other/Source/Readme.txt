DEVELOPER: Replace the three occurrences of PsiphonPortable in this file
...
user in an INI file next to PsiphonPortable.exe called PsiphonPortable.ini.
...
copy AppNamePortable.ini from this directory to PsiphonPortable.ini next to
PsiphonPortable.exe. The options in the INI file are as follows:
