DEVELOPER: Replace the three occurrences of FileBrowserPortable in this file
...
user in an INI file next to FileBrowserPortable.exe called FileBrowserPortable.ini.
...
copy AppNamePortable.ini from this directory to FileBrowserPortable.ini next to
FileBrowserPortable.exe. The options in the INI file are as follows:
