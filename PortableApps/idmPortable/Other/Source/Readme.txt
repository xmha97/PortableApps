...
user in an INI file next to idmPortable.exe called idmPortable.ini.
...
copy AppNamePortable.ini from this directory to idmPortable.ini next to
idmPortable.exe. The options in the INI file are as follows:
