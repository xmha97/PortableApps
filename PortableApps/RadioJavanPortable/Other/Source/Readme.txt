DEVELOPER: Replace the three occurrences of RadioJavanPortable in this file
...
user in an INI file next to RadioJavanPortable.exe called RadioJavanPortable.ini.
...
copy AppNamePortable.ini from this directory to RadioJavanPortable.ini next to
RadioJavanPortable.exe. The options in the INI file are as follows:
