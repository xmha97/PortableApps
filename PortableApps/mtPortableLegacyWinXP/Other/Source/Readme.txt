DEVELOPER: Replace the three occurrences of mtPortableLegacyWinXP in this file
...
user in an INI file next to mtPortableLegacyWinXP.exe called mtPortableLegacyWinXP.ini.
...
copy AppNamePortable.ini from this directory to mtPortableLegacyWinXP.ini next to
mtPortableLegacyWinXP.exe. The options in the INI file are as follows:
