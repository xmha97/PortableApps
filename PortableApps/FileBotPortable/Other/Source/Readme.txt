...
user in an INI file next to FileBotPortable.exe called FileBotPortable.ini.
...
copy AppNamePortable.ini from this directory to FileBotPortable.ini next to
FileBotPortable.exe. The options in the INI file are as follows:
