...
user in an INI file next to GeoGebraPortable.exe called GeoGebraPortable.ini.
...
copy AppNamePortable.ini from this directory to GeoGebraPortable.ini next to
GeoGebraPortable.exe. The options in the INI file are as follows:
