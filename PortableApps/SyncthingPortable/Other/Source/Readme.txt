...
user in an INI file next to SyncthingPortable.exe called SyncthingPortable.ini.
...
copy AppNamePortable.ini from this directory to SyncthingPortable.ini next to
SyncthingPortable.exe. The options in the INI file are as follows:
