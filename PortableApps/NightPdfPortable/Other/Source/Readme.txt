DEVELOPER: Replace occurrences of NightPdfPortable in this file with the
...
user in an INI file next to NightPdfPortable.exe called NightPdfPortable.ini.
...
copy AppNamePortable.ini from this directory to NightPdfPortable.ini next to
NightPdfPortable.exe. The options in the INI file are as follows:
