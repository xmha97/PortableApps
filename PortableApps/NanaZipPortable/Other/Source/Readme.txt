...
user in an INI file next to NanaZipPortable.exe called NanaZipPortable.ini.
...
copy AppNamePortable.ini from this directory to NanaZipPortable.ini next to
NanaZipPortable.exe. The options in the INI file are as follows:
