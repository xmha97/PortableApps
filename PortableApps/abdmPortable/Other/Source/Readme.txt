DEVELOPER: Replace the three occurrences of abdmPortable in this file
...
user in an INI file next to abdmPortable.exe called abdmPortable.ini.
...
copy AppNamePortable.ini from this directory to abdmPortable.ini next to
abdmPortable.exe. The options in the INI file are as follows:
