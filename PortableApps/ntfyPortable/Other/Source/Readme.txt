DEVELOPER: Replace the three occurrences of ntfyPortable in this file
...
user in an INI file next to ntfyPortable.exe called ntfyPortable.ini.
...
copy AppNamePortable.ini from this directory to ntfyPortable.ini next to
ntfyPortable.exe. The options in the INI file are as follows:
