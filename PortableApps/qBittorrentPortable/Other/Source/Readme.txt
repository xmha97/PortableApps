...
user in an INI file next to qBittorrentPortable.exe called 
qBittorrentPortable.ini. If you are happy with the default options, it is not 
...
qBittorrentPortable.ini next to qBittorrentPortable.exe. The options in the 
