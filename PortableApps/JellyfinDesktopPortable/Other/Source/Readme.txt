DEVELOPER: Replace the three occurrences of JellyfinDesktopPortable in this file
...
user in an INI file next to JellyfinDesktopPortable.exe called JellyfinDesktopPortable.ini.
...
copy AppNamePortable.ini from this directory to JellyfinDesktopPortable.ini next to
JellyfinDesktopPortable.exe. The options in the INI file are as follows:
