...
(For this section, FarManagerPortable is the executable base file name, normally
the App ID of the package.)

Some configuration in the PortableApps.com Launcher can be overridden by the
user in an INI file next to FarManagerPortable.exe called FarManagerPortable.ini.  If
...
PortableApps.comLauncher.ini from this directory to FarManagerPortable.ini next to
FarManagerPortable.exe. The options in the INI file are as follows::
