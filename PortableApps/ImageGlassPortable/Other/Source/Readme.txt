...
user in an INI file next to ImageGlassPortable.exe called ImageGlassPortable.ini.
...
copy AppNamePortable.ini from this directory to ImageGlassPortable.ini next to
ImageGlassPortable.exe. The options in the INI file are as follows:
