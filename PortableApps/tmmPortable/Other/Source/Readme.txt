DEVELOPER: Replace the three occurrences of tmmPortable in this file
...
user in an INI file next to tmmPortable.exe called tmmPortable.ini.
...
copy AppNamePortable.ini from this directory to tmmPortable.ini next to
tmmPortable.exe. The options in the INI file are as follows:
