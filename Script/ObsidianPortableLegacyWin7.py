...
shutil.copyfile(PurePath(pf,'Online','ObsidianPortableLegacyWin7','installer.ini'),PurePath(pf,'Source','ObsidianPortableLegacyWin7_online','App','AppInfo','installer.ini'))
shutil.copyfile(PurePath(pf,'Online','ObsidianPortableLegacyWin7','PortableApps.comInstallerCustom.nsh'),PurePath(pf,'Source','ObsidianPortableLegacyWin7_online','Other','Source','PortableApps.comInstallerCustom.nsh'))
