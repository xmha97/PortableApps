DEVELOPER: Replace occurrences of SimplenotePortable in this file with the
...
user in an INI file next to SimplenotePortable.exe called SimplenotePortable.ini.
...
copy AppNamePortable.ini from this directory to SimplenotePortable.ini next to
SimplenotePortable.exe. The options in the INI file are as follows:
