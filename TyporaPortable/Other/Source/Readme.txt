DEVELOPER: Replace the three occurrences of TyporaPortable in this file
...
user in an INI file next to TyporaPortable.exe called TyporaPortable.ini.
...
copy AppNamePortable.ini from this directory to TyporaPortable.ini next to
TyporaPortable.exe. The options in the INI file are as follows:
