DEVELOPER: Replace the three occurrences of JellyfinPortable in this file
...
user in an INI file next to JellyfinPortable.exe called JellyfinPortable.ini.
...
copy AppNamePortable.ini from this directory to JellyfinPortable.ini next to
JellyfinPortable.exe. The options in the INI file are as follows:
