DEVELOPER: Replace the three occurrences of ObsidianPortableLegacyWin7 in this file
...
user in an INI file next to ObsidianPortableLegacyWin7.exe called ObsidianPortableLegacyWin7.ini.
...
copy AppNamePortable.ini from this directory to ObsidianPortableLegacyWin7.ini next to
ObsidianPortableLegacyWin7.exe. The options in the INI file are as follows:
