DEVELOPER: Replace occurrences of HiddifyPortable in this file with the
...
user in an INI file next to HiddifyPortable.exe called HiddifyPortable.ini.
...
copy AppNamePortable.ini from this directory to HiddifyPortable.ini next to
HiddifyPortable.exe. The options in the INI file are as follows:
