DEVELOPER: Replace the three occurrences of jmpPortable in this file
...
user in an INI file next to jmpPortable.exe called jmpPortable.ini.
...
copy AppNamePortable.ini from this directory to jmpPortable.ini next to
jmpPortable.exe. The options in the INI file are as follows:
