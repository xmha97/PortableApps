DEVELOPER: Replace the three occurrences of jmpPortableLegacyWin7 in this file
...
user in an INI file next to jmpPortableLegacyWin7.exe called jmpPortableLegacyWin7.ini.
...
copy AppNamePortable.ini from this directory to jmpPortableLegacyWin7.ini next to
jmpPortableLegacyWin7.exe. The options in the INI file are as follows:
