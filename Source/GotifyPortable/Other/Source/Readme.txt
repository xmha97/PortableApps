DEVELOPER: Replace the three occurrences of GotifyPortable in this file
...
user in an INI file next to GotifyPortable.exe called GotifyPortable.ini.
...
copy AppNamePortable.ini from this directory to GotifyPortable.ini next to
GotifyPortable.exe. The options in the INI file are as follows:
