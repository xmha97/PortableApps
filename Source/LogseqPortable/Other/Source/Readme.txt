DEVELOPER: Replace the three occurrences of LogseqPortable in this file
...
user in an INI file next to LogseqPortable.exe called LogseqPortable.ini.
...
copy AppNamePortable.ini from this directory to LogseqPortable.ini next to
LogseqPortable.exe. The options in the INI file are as follows:
